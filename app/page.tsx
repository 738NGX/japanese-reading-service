...
import type { ConvertResult, ReadingCombinationCandidate, ReadingMode } from '@/lib/japanese-reading/types';
...
export default function Home() {
  ...
  return <main>
    ...
    <section className="tool" aria-label="读音查询工具">
      ...
      {result ? <Results result={result} /> : <p className="hint">使用 OpenCC 实时转换为日文新字体；整词词典命中会优先显示。</p>}
    </section>
